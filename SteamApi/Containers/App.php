...
class App {
	...
	public function __construct($app)
	{
		...
		$this->developers         = isset($app->developers) ? $app->developers : null;
		...
		$this->categories         = isset($app->categories) ? $app->categories : null;
		$this->genres             = isset($app->genres) ? $app->genres : null;
